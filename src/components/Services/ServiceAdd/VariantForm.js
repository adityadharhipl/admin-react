...
const VariantForm = ({ variant, attributes, index, onFieldChange, onSelectChange, onAddVariant, onDuplicateVariant }) => {
    ...
    const handleAddPair = () => {
        setAttributePairs([...attributePairs, { attribute: null, value: [] }]);
    };

    const handleRemovePair = (pairIndex) => {
        setAttributePairs(attributePairs.filter((_, index) => index !== pairIndex));
    };
                                ...
                                <div className='row'>
                                    <div className="col-md-6">
                                        ...
                                        <Select
                                            ...
                                            options={attributes.map(item => ({ label: item.attributeName, value: item._id }))}
